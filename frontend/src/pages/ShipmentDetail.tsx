          ...
          <div className="flex items-center space-x-6 text-right">
            ...
            <div className="relative group">
              <div className="text-[10px] text-slate-400 uppercase font-extrabold tracking-wider flex items-center justify-end cursor-help">
                ...
                <Info className="w-3 h-3 ml-1 text-indigo-400" />
              </div>
              <div className="text-2xl font-black text-indigo-300 flex items-center justify-end">
            ...
            {/* Metric 3: Deadline Buffer */}
            <div>
              <div className="text-[10px] text-slate-500 uppercase font-extrabold tracking-wider">Deadline Buffer</div>
              <div className="text-2xl font-black text-amber-400 flex items-center justify-end">
